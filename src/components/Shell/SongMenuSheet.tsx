...
export const SongMenuSheet: React.FC<SongMenuSheetProps> = ({ isOpen, onClose, onOpenExport }) => {
  ...
  return (
    <div className="sheet-backdrop fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/75 backdrop-blur-sm p-0 sm:p-4">
      <div className="sheet-panel w-full sm:max-w-lg bg-surface-1 border-t sm:border border-strong-divider rounded-t-2xl sm:rounded-2xl max-h-[85vh] flex flex-col overflow-hidden shadow-2xl">
        {/* Header */}
